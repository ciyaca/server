...
--
-- Current Database: `ciyaca`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `ciyaca` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `ciyaca`.`user_BEFORE_INSERT` BEFORE INSERT ON `user` FOR EACH ROW
BEGIN
